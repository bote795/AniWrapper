 ...
 * @property {Number} media.id - id of media entry
 * @property {Number} media.episodes - number of episodes of the series
 * @property {Object} media.coverImage
 * @property {String} media.coverImage.medium - url of medium image
 * @property {Object} media.title
 * @property {String} media.title.userPreferred - title in user perferred
 * @property {String} media.title.romaji - title of media in romaji
 * @property {String} media.title.english - title of media in egnlish
 */
...
class Anilist {
   ...
   * @returns {Promise}  AnimeSearch.media media {@link Media}
   * @example
    const name = 'nar';
    const token = '<Your_TOKEN>';
    const anilist = new Anilist(token);
