...
const { getUserListById, removeMedia, updateMedia, searchAnime } = queries;
...
class Anilist {
  static get URL() {
    return 'https://graphql.anilist.co/api/v2/';
  }
  ...
  constructor(accessToken) {
    ...
    this.client = new GraphQLClient(Anilist.URL, {
      headers: {
   ...
   */
  searchAnime(name) {
    return searchAnime(this.client, { query: name });
  }
   ...
   */
  removeAnime(id) {
    return removeMedia(this.client, { id });
  }
}
